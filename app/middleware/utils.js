...
exports.ADMIN = [1, 'admin']
exports.DRIVER = [2, 'driver', 1, 'admin']
exports.STANDARD = [3, 'standard', 2, 'driver', 1, 'admin']
...
/**
 * Builds success object for static confirmations
...
exports.isIDGood = async id => {
	return new Promise((resolve, reject) => {
		const goodID = String(id).match(/[0-9]+/)
		return goodID
			? resolve(id)
